...
def parse_date(date_str: str) -> date | None:
    ...
    Handles:
        ...
        'next Monday', 'coming Friday', 'this Thursday'
        '20 Feb', 'Feb 20', '20-02-2026', '2026-02-20', '20/02/2026'
        'in 3 days'
    """
    if not date_str:
        return None
...
def parse_time(time_str: str) -> dt_time | None:
    ...
    Handles:
        '3pm', '3:30 PM', '10am', '10:00 AM'
        'morning 10', 'afternoon 3', 'evening 6:30'
        '14:00', '9', '9:30'
    """
    if not time_str:
        return None
    ...
    # Detect period hints from keywords
    period_hint = None
    if any(w in s for w in ["morning"]):
        period_hint = "am"
    elif any(w in s for w in ["afternoon", "evening", "night"]):
        period_hint = "pm"
    ...
    if m:
        ...
        if ampm == "pm" and hour != 12:
            ...
            hour = 0
        elif ampm is None and hour < 9:
            # Ambiguous — assume PM for afternoon hours (e.g. "6" → 6 PM)
            hour += 12
...
def format_date_for_db(d: date) -> str:
    """Returns: '20-02-2026' — standard storage format."""
...
def dob_to_db_format(dob_str: str) -> str:
    """
    Normalise DOB to DD-MM-YYYY storage format.
